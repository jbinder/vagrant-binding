...
public class VagrantVmConfig {
     ...
     * @param additional config lines as string, where [vmConfigName] is replaced with the according value
	...
	public VagrantVmConfig(String name, String ip, String hostName, String boxName, URL boxUrl, String guest,
                           ...
                           List<String[]> customizeVm, String bashProvisionScript, String additionalConfig) {
